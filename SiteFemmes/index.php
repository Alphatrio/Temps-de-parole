...
<body>
	<div class="jumbotron" style ="margin-bottom:0px; background: linear-gradient(to bottom right, #5b5ea6,50%,#363763) ">
	...
	<p>
		...
		<br>In William Shakespeare's Hamlet, "to be, or not to be, that is the question." In the 21st century, "to code, or not to code, that is the challenge.
		<br>By the pricking of my thumbs, Something wicked this way comes. Open, locks, Whoever knocks!
		<br>Hell is empty and all the devils are here.
		<br>Now is the winter of our discontent.
		...
		<br>These violent delights have violent ends...
		<br>Brevity is the soul of wit.
		<br>Fair is foul, and foul is fair: Hover through the fog and filthy air.
	...
	<footer class="bg-dark text-center text-white fixed-bottom">
		<div class="container p-4">
			<h3 style= "text-align = auto;">
				Bienvenue sur
				<?php
					$actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
					//substring(string $actual_link,28,(strlen($actual_link)-4));
					echo $actual_link;
				?>
	...
	<footer class="bg-dark text-center text-white">
	  ...
	  <div class="container p-4">
		...
		<section class="">
		  <form action="">
			...
			<div class="row d-flex justify-content-center">
			  ...
			  <div class="col-auto">
				<p class="pt-2">
				  <strong>Inscrivez vous à nos notifcations par mail</strong>
				</p>
			  </div>
			  <!--Grid column-->
		...
		<section class="mb-4">
		  <p>
			Le but de ce site est informatif, les données viennent de ce <a href="https://www.data.gouv.fr/en/datasets/temps-de-parole-des-hommes-et-des-femmes-a-la-television-et-a-la-radio/#_">site</a>, son traitement et sa mise en forme ont étés faits dans le contexte universitaire.
		  </p>
		</section>
